 ...
 */
final class Version20190212142855 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5D9F75A19D86650F ON employee');
        $this->addSql('ALTER TABLE employee CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employee CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE employee ADD CONSTRAINT FK_5D9F75A19D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_5D9F75A19D86650F ON employee (user_id_id)');
    }
}
